...
def get_stock_price(symbol):
    # Append '-USD' for cryptocurrencies to get their price in USD
    if symbol  in ['BTC', 'ETH']:  # Add other stock symbols if needed
        symbol += '-USD'
...
def stock_agent(input_prompt: str) -> str:
    ...
    open_ai_agent = initialize_agent(tools,
                            ...
                            verbose=True)
    return open_ai_agent.run(input_prompt)

if __name__ == "__main__":
    print(stock_agent("get the price of BTC"))
    print(stock_agent("get the percentage change of BTC over the last 7 days"))
    print(stock_agent("get the best performing stock from BTC, ETH, and DOGE over the last 7 days"))